<template>
	<view>
		<scroll-view scroll-y class="page">
			...
			<view class="nav-list">
				<navigator hover-class="none" :url="'/pages/unicorn-ext/unicorn-ext?extName=' + item.extName" 
					class="nav-li" navigateTo :class="'bg-'+item.color" :style="[{animation: 'show ' + ((index+1)*0.2+1) + 's 1'}]"
